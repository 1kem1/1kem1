...
### Python · Deep Learning · Remote Sensing · GIS

专注于 Python、深度学习、遥感影像处理与地理信息系统，关注 AI 在空间数据分析、遥感智能解译和 GIS 应用中的实践。
...
- 关注 Python 在遥感与地理信息领域中的应用
- 研究方向包括遥感影像处理、深度学习、空间数据分析与 GIS
